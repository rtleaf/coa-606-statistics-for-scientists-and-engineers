...
+ Regression model is much different from using the mean (null model) as the outcome, therefore regression model improves the outcome.
...
We find that the TSS is = 19.656923

We find that the Model SS = 19.132214
...
*Summary of the Calculations for testing $H_0:\beta=0$ against $H_A:\beta\ne0$ by an Analysis of Variance*

+ DF for Regression (model DF) is 1 in simple linear regression, It is the number of parameters - 1
+ Residual DF (Error DF) is equal n - 2 (why?)
